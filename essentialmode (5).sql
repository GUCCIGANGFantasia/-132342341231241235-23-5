...
-- Listage de la structure de la base pour server
CREATE DATABASE IF NOT EXISTS `server` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `server`;

-- Listage de la structure de la table server. banking_account
...
-- Listage de la structure de la table server. phone_app_chat
...
-- Listage des données de la table server.phone_app_chat : ~0 rows (environ)
/*!40000 ALTER TABLE `phone_app_chat` DISABLE KEYS */;
/*!40000 ALTER TABLE `phone_app_chat` ENABLE KEYS */;

-- Listage de la structure de la table server. phone_calls
...
-- Listage des données de la table server.phone_calls : ~0 rows (environ)
/*!40000 ALTER TABLE `phone_calls` DISABLE KEYS */;
/*!40000 ALTER TABLE `phone_calls` ENABLE KEYS */;

-- Listage de la structure de la table server. phone_messages
...
-- Listage des données de la table server.phone_messages : 1 rows
...
-- Listage de la structure de la table server. phone_users_contacts
...
-- Listage des données de la table server.phone_users_contacts : 0 rows
/*!40000 ALTER TABLE `phone_users_contacts` DISABLE KEYS */;
/*!40000 ALTER TABLE `phone_users_contacts` ENABLE KEYS */;

-- Listage de la structure de la table server. players_appartement
...
-- Listage des données de la table server.players_appartement : ~0 rows (environ)
...
-- Listage de la structure de la table server. players_appearance
...
-- Listage de la structure de la table server. players_jobs
...
-- Listage de la structure de la table server. players_parking
...
-- Listage des données de la table server.players_parking : ~0 rows (environ)
...
-- Listage de la structure de la table server. players_settings
...
-- Listage des données de la table server.players_settings : ~0 rows (environ)
/*!40000 ALTER TABLE `players_settings` DISABLE KEYS */;
/*!40000 ALTER TABLE `players_settings` ENABLE KEYS */;

-- Listage de la structure de la table server. players_vehicles
...
-- Listage des données de la table server.players_vehicles : ~0 rows (environ)
...
-- Listage de la structure de la table server. players_weapon
...
-- Listage des données de la table server.players_weapon : ~0 rows (environ)
/*!40000 ALTER TABLE `players_weapon` DISABLE KEYS */;
/*!40000 ALTER TABLE `players_weapon` ENABLE KEYS */;

-- Listage de la structure de la table server. server_logs
...
-- Listage des données de la table server.server_logs : ~0 rows (environ)
/*!40000 ALTER TABLE `server_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `server_logs` ENABLE KEYS */;

-- Listage de la structure de la table server. storages_inventory_accounts
...
-- Listage des données de la table server.storages_inventory_accounts : 12 rows
...
-- Listage de la structure de la table server. storages_inventory_items
...
-- Listage des données de la table server.storages_inventory_items : 50 rows
...
-- Listage de la structure de la table server. users
...
-- Listage des données de la table server.users : ~1 rows (environ)
...
-- Listage de la structure de la table server. whitelist
...
-- Listage des données de la table server.whitelist : ~9 rows (environ)
...
INSERT INTO `whitelist` (`id`, `identifier`, `character_count`, `character_limit`, `permanent_ban`, `ban_expire_at`) VALUES
	...
	(11, 'steam:1100001344209f9', 0, 1, 0, NULL),
        (12, 'steam:110000139c00e94', 0, 1, 0, NULL);
